  ...
  return (
    <div className="max-w-3xl p-6 bg-white rounded-lg">
      ...
      <p className="text-gray-600 mb-4">
        This site shows working examples of embedding Rill dashboards into a web
        app. Use the sidebar to browse the examples by topic; each page is a
        self-contained demo with the iframe request that powers it.
      </p>
      <p className="text-gray-600 mb-6">For deeper context, see:</p>
