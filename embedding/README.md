...
- `rill-project/`: A Rill project defining dashboards that we'll be embedding, derived from the `rill-openrtb-prog-ads` example. Deployed to Rill Cloud at [ui.rilldata.com/demo/rill-embedding](https://ui.rilldata.com/demo/rill-embedding).
...
- Test (uses `ui.rilldata.in/demo/rill-embedding`): [rill-embedding-example-test.netlify.app]() [![Netlify Status](https://api.netlify.com/api/v1/badges/13cef1d4-e51b-404e-ac5f-e4f4e93808f3/deploy-status)](https://app.netlify.com/projects/rill-embedding-example-test/deploys)
